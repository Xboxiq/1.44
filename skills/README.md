...
4. **`04-prompt-razor`** — مهارة سلوكية لضغط البرومتات وخفض استهلاك التوكنز (40–80%): ضغط رمزي، طبقات صديقة للكاش، مخرجات مُهيكلة، وكبح حشو المخرجات.

> القاعدة: **التصميم أولاً (UI/UX)** يحكم القرارات، ثم تقنية التنفيذ (Flutter أو Web) حسب المشروع. مهارة `04-prompt-razor` مستعرضة (cross-cutting) وتُفعَّل عند كتابة/مراجعة أي برومت أو تعليمات وكيل.
